module gitlab.com/wordbyword.io/microservices/gateways/gateway-api
...
require (
	...
	gitlab.com/wbwapis/go-genproto v0.0.0-20240519071514-20813b4fa153
	gitlab.com/wordbyword.io/microservices/pkg v0.0.11
