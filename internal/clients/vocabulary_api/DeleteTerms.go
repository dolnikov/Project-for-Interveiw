...
func (c *VocabularyApiClient) DeleteTerms(ctx context.Context, request *VocabularyApiProto.DeleteTermsRequest) (response *VocabularyApiProto.DeleteTermsResponse, err error) {
