...
func (c *VocabularyApiClient) DeleteCollection(ctx context.Context, request *VocabularyApiProto.DeleteCollectionRequest) (response *VocabularyApiProto.DeleteCollectionResponse, err error) {
