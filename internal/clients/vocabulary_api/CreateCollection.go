...
func (c *VocabularyApiClient) CreateCollection(ctx context.Context, request *VocabularyApiProto.CreateCollectionRequest) (response *VocabularyApiProto.CreateCollectionResponse, err error) {
