...
func (c *VocabularyApiClient) UpdateTerm(ctx context.Context, request *VocabularyApiProto.UpdateTermRequest) (response *VocabularyApiProto.UpdateTermResponse, err error) {
