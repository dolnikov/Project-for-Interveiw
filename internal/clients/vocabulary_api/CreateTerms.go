...
func (c *VocabularyApiClient) CreateTerms(ctx context.Context, request *VocabularyApiProto.CreateTermsRequest) (response *VocabularyApiProto.CreateTermsResponse, err error) {
